# react-package-scripts <!-- omit in toc -->

This package includes scripts and configuration used by [Create React Package](#create-react-package). A zero-config CLI for creating react packages.
